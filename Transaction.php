    ...
    <body>
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST") {
          ...
          function validate_input($data){
            ...
            $time = date("h:i:sa");
            $email =  $_SESSION["Name"];
            $stmt = $connection->prepare("INSERT INTO transactions(Product,
            Quantity, Price, Total,Email,Date,Time)
            VALUES (?,?,?,?,?,?,?)");
             $stmt->bind_param("sssssss",$productname, $quantity, $price,$total,$email,$date,$time);
             if( $stmt->execute() === TRUE){
              $success = "<div class='alert alert-success' role='alert'>"." You have succcessfully record  your transaction "."</div>";
             }
             else{
              $errormsg = "<div class='alert alert-danger' role='alert'>"."We are sorry something was went wronged recording the transaction"."</div>"; 
             }
          }
    ?>
            ...
            <div id="page-content-wrapper">
                ...
                <div class="row">
                     ...
                     <div class="row">
                            ...
                            <h1 class="h3  mb-5 font-weight-normal">Record Transaction </h1>
                            </div>
                           ...
                           <div class="row ">
                               ...
                               <input type="text" name="productname"  id="inputname" class="form-control  mb-5" placeholder="Product name" required autofocus>
                               </div>
                               <div class="col-md-4 col-lg-4 col-sm-3"></div>
                             </div>
                           ...
                           <div class="row ">
                               ...
                               <input type="number" name="quantity"  id="inputquantity" class="form-control  mb-5" placeholder="Quantity" required autofocus>
                               </div>
                               <div class="col-md-4 col-lg-4 col-sm-3"></div>
                             </div>
                           ...
                           <div class="row ">
                               ...
                               <input type="number" name="price"  class="form-control  mb-5" placeholder="Price" required autofocus>
                               </div>
                               <div class="col-md-4 col-lg-4 col-sm-3"></div>
                             </div>
                             ...
                             <div class="row ">
                               <div class="col-md-3 col-lg-3 col-sm-4"></div>
                               <div class="col-md-5 col-lg-5 col-sm-5">
                               <button class="btn btn-lg btn-primary btn-block mb-5" type="submit">Submit</button>
                                </div>
                               <div class="col-md-4 col-lg-4 col-sm-3"></div>
                             </div>
