   ...
   font-weight : bold;
    ...
    <body>
      <?php  require 'Authentication.php';
             ...
             if(isset($_GET['id'])){
                $id = $_GET['id'];
                $sql = "SELECT Id,Product,Quantity,Price,Total FROM transactions WHERE  Id =  $id ";
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST") {
          ...
          function validate_input($data){
            ...
            $productname = validate_input($_POST["productname"]);
            ...
            $time = date("h:i:sa");
            $email =  $_SESSION["Name"];
            $stmt = $connection->prepare("UPDATE  transactions SET Product=?,
            Quantity=?, Price = ?, Total =? WHERE Id= ? ");
             $stmt->bind_param("sssss",$productname, $quantity, $price,$total,$id);
             if( $stmt->execute() === TRUE){
              $success = "<div class='alert alert-success' role='alert'>"." You have succcessfully updated  your transaction "."</div>";
             }
             else{
              $errormsg = "<div class='alert alert-danger' role='alert'>"."We are sorry something was went wronged updating  the transaction"."</div>"; 
             }
          }
    ?>
            ...
            <div id="page-content-wrapper">
                ...
                <div class="row">
                     ...
                     <div class="row">
                            ...
                            <h1 class="h3  mb-5 font-weight-normal">Update  Transaction </h1>
                            </div>
                           ...
                           <div class="row ">
                               ...
                               <input type="text" name="productname"  id="inputname" value="<?php echo $productname;  ?>" class="form-control  mb-5" placeholder="Product name" required autofocus>
                               </div>
                               <div class="col-md-4 col-lg-4 col-sm-3"></div>
                             </div>
                           ...
                           <div class="row ">
                               ...
                               <input type="number" name="quantity"  id="inputquantity" value="<?php echo $quantity;  ?>" class="form-control  mb-5" placeholder="Quantity" required autofocus>
                               </div>
                               <div class="col-md-4 col-lg-4 col-sm-3"></div>
                             </div>
                           ...
                           <div class="row ">
                               ...
                               <input type="number" name="price" value="<?php echo $price; ?>" class="form-control  mb-5" placeholder="Price" required autofocus>
                               </div>
                               <div class="col-md-4 col-lg-4 col-sm-3"></div>
                             </div>
