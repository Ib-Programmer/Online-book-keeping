...
<div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <div class=" col-md-9 col-sm-10  container-fluid">
                    <div class="row ">
                    <h2 class="mt-4 mb-5"> View Transactions</h2>
                    <?php
                    $per_page_record = 5;
                    if(isset($_GET['page'])){
                     $page = $_GET["page"];
                  ...
                  $sql = "SELECT * FROM transactions WHERE Email = '$email' LIMIT $start_from ,$per_page_record";
                ...
                <?php 
                 if($result->num_rows > 0){ 
                    while($row = $result->fetch_assoc()){
                      ...
                      <tr><td>
                         <?php echo $row["Id"]; ?>
                                ...
                                <?php echo $row["Time"]; ?>
                                 ...
                                 <a href="Delete.php?deltran=<?php echo $row['Id'];?>"><button class="btn btn-danger mb-2">Delete</button></a>
                                 </td><td>
                                 <a href="Updatetransaction.php?id=<?php echo $row['Id'];?>"><button class="btn btn-primary mb-2">Update</button></a>
                                 </td>
                                </tr><br>
                               ...
                               <?php 
                                 ...
                                 $sql = "SELECT  COUNT(*) FROM  transactions  WHERE Email = '$email'";
                                 $result = $connection->query($sql);
                     ...
                     <p>
                        ...
                        if($page>=2){
                             ...
                             echo "<li class='page-item'><a class = 'page-link' href='Viewtransaction.php?page=".($page-1)."'>Pre </a></li>";
                         }
                      for($i=1;$i<=$total_pages;$i++){
                      if($i==$page){
                          $pagelink .="<li class='page-item'><a class= 'page-link' href='Viewtransaction.php?page=".$i."'>".$i."</a></li>";
                        }
                     else{
                      $pagelink .= "<li class='page-item'><a class='page-link' href='Viewtransaction.php?page=".$i."'>".$i."</a></li>";
                     }
                   ...
                   echo $pagelink;
                 if($page<$total_pages){
                   echo "<li class='page-item'><a class='page-link' href ='Viewtransaction.php?page=".($page + 1)."'>Next </a></li>";
                   }
                   echo "</ul>";
                   echo "</nav>";
                   $connection->close();
