...
<div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <div class=" col-md-9 col-sm-10  container-fluid">
                    <div class="row ">
                    <h2 class="mt-4 mb-5"> View Users  Message</h2>
                    <?php
                    $per_page_record = 5;
                    if(isset($_GET['page'])){
                     $page = $_GET["page"];
                ...
                <?php 
                 if($result->num_rows > 0){ 
                    while($row = $result->fetch_assoc()){
                      ...
                      <tr><td>
                         <?php echo $row["Id"]; ?>
                                ...
                                <td>
                                 <a href="Delete.php?delmsg=<?php echo $row['Id'];?>"><button class="btn btn-danger mb-2">Delete</button></a>
                                 </td>
                                </tr><br>
                     ...
                     <p>
                        ...
                        if($page>=2){
                             ...
                             echo "<li class='page-item'><a class = 'page-link' href='Viewsuggestion.php?page=".($page-1)."'>Pre </a></li>";
                         }
                      for($i=1;$i<=$total_pages;$i++){
                      if($i==$page){
                          $pagelink .="<li class='page-item'><a class= 'page-link' href='Viewsuggestion.php?page=".$i."'>".$i."</a></li>";
                        }
                     else{
                      $pagelink .= "<li class='page-item'><a class='page-link' href='Viewsuggestion.php?page=".$i."'>".$i."</a></li>";
                     }
                   ...
                   echo $pagelink;
                 if($page<$total_pages){
                   echo "<li class='page-item'><a class='page-link' href ='Viewsuggestion.php?page=".($page + 1)."'>Next </a></li>";
                   }
                   echo "</ul>";
                   echo "</nav>";
                   $connection->close();
